"""M5. Early Warning Center - 지주사 조기경보 센터"""
...
# Risk Heatmap
st.subheader("Risk Heatmap (계열사 x 리스크 유형)")
...
if not risk_df.empty:
    ...
    st.dataframe(
        ...
        .rename(columns={
            "bu_name": "계열사", "category": "유형", "description": "설명",
...
# KPI 이탈 경보
st.subheader("KPI 이탈 경보 (계획 대비 -5% 이상 미달)")
...
if not alert_df.empty:
    ...
    if not recent_alerts.empty:
        ...
        fig2 = px.bar(
            ...
            labels={"avg_gap_pct": "평균 Gap (%)", "kpi_id": "KPI", "bu_name": "계열사"},
        )
